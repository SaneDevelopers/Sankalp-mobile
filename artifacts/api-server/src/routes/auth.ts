    ...
    try {
      if (idToken === "mock_dev_google_id_token") {
        ...
        if (
          ...
          const supabaseUrl = process.env.SUPABASE_URL;
          // IMPORTANT: Do NOT fallback to SUPABASE_JWT_SECRET for the apikey header!
          const supabaseAnonKey = process.env.SUPABASE_ANON_KEY || "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imd5cGVsZmV6YnVscXpnc250c2ZhIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODE0MzE3NDgsImV4cCI6MjA5NzAwNzc0OH0.2VMfnYbouPYxV-K1KBWLHeIQJg9zFqDTdww_SE7wXHM";
